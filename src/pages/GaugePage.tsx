...
import { getGaugeFillColor, getOverlayColor } from '../hooks/gaugeUtils';
    ...
    return (
        <div className='relative w-full h-screen flex  justify-center'>
            ...
            <div className='items-center z-20'>
                {gauge >= 100 && (
                    <h2 className='absolute text-center text-4xl text-red-600 font-bold left-1/2 transform -translate-x-1/2  top-8'>
                        BREAK!
                    </h2>
                )}
                ...
                <div className='absolute bottom-[6.2rem] z-20 left-1/2 transform -translate-x-1/2 '>
                    <Button onClick={incrementGauge} />
                </div>
            </div>

            <div className='absolute md:right-[6rem] right-12 flex flex-col'>
                <div className='w-12 h-64 border top-[19rem] border-white radius relative overflow-hidden rounded-full shadow-inner'>
                    <div
